  ...
  <jsp:include page="nav.jsp"/>
   ...
   <main class="mt-3">
    <div class="container">
      ...
      <form id="frm" action="p_update" method="post">
      <input type="hidden" name="id" value="${pic.id}"/>
      <input type="hidden" name="category_id" id="category_id"/>
      <div class="mb-3 row">
        <label class="col-md-3 col-form-label">제품명</label>
        <div class="col-md-9">
          <input type="text" class="form-control" name="product_name" value="${pic.product_name}">
        </div>
      </div>
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="number" class="form-control" name="product_price" value="${pic.product_price}">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="number" class="form-control" name="delivery_price" value="${pic.delivery_price}">
            <span class="input-group-text">원</span>
          </div>
        </div>
      </div>
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="number" class="form-control" name="add_delivery_price" value="${pic.add_delivery_price}">
            <span class="input-group-text">원</span>
          </div>
        </div>
      </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control" name="tags" value="${pic.tags}">
        </div>
      </div>
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="number" class="form-control" name="outbound_days" value="${pic.outbound_days}">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-6 d-grid p-1">
          <button type="button" class="btn btn-lg btn-danger" onclick="goUpdate()">수정하기</button>
        </div>
      </div>
      </form>
    </div>
  ...
  <script type="text/javascript">
     ...
     function categoryPart(data){    	 
    	 ...
    	 for(let key in category1) {    		
    		 if(category1[key]=='${cate.category1}'){
     		   cate1+="<option selected value='"+category1[key]+"'>"+category1[key]+"</option>";	 
    		 }else{
    	 ...
    	 for(let key in category2) {
    		 console.log(category2[key]+'${cate.category2}');
	    	 if(category2[key]=='${cate.category2}'){
	   		   cate2+="<option selected value='"+category2[key]+"'>"+category2[key]+"</option>";	 
	  		 }else{
    	 ...
    	 cate3+="<option selected value='${cate.category3}'>${cate.category3}</option>";
    	 cate3+="</select>";
    	 $("#cate3").html(cate3);
